...
const DICT = {
  en: {
    ...
    shareNote: 'Anyone with this link or QR can view this chat, read-only. Media links stay valid about a year.',
  },
  hi: {
    langName: 'हिन्दी',
    // ---- Landing ----
    ...
    shareNote: 'जिसके पास ये लिंक या QR होगा वो ये चैट देख सकता है — सिर्फ़ पढ़ने के लिए। मीडिया लिंक लगभग एक साल तक चलते हैं।',
  },
} as const;
